    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url("/addUsers")}}">
              <span class="menu-icon">
              ...
              <div class="col-md-8 m-auto grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="{{url("/add")}}" method="POST" class="forms-sample" enctype="multipart/form-data">
                      @csrf
                      <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Product Name</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control text-white" id="exampleInputUsername2" placeholder="Product Name" name="pName">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Price</label>
                        <div class="col-sm-9">
                          <input type="number" class="form-control text-white" id="exampleInputEmail2" placeholder="Price" name="price">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputMobile" class="col-sm-3 col-form-label">Quntity</label>
                        <div class="col-sm-9">
                          <input type="number" class="form-control text-white" id="exampleInputMobile" placeholder="Quntity" name="quntity">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Description</label>
                        <div class="col-sm-9">
                          <textarea class="form-control text-white" id="exampleInputPassword2" placeholder="Description" name="desc"></textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <label for="role" class="col-sm-3 col-form-label">Product Type</label>
                        <div class="col-sm-9" id="">
                          <input type="text" class="form-control text-white" name="role" value="woeman">
                        </div>
                      </div>
