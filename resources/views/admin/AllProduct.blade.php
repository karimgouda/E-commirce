          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">All Proudct</h4>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="w-75 m-auto">
                                <img style="border-radius: 5px" class="w-100" src="{{asset("storage/$product->image")}}" alt="">
                              </div>
                            </td>
                            <td>{{$product->role}}</td>
                            ...
                            <td class=" col ">
                              <div style="display: flex; ">
                                <div style="padding: 0px 10px">
                                  <a href="{{url("editProduct/$product->id")}}" class=" btn btn-warning">Edit</a>
                                </div>
                                <div style="padding: 0px 10px">
                                  <a href="{{url("single/$product->id")}}" class=" btn btn-success">View product</a>
                                </div>
                                <div>
                                  ...
                                  <form action="{{url("/delete/$product->id")}}" method="POST" enctype="multipart/form-data">
                                    @method('DELETE')
                                    @csrf
                                    <button onclick="alert('Are you sure about the deletion ')" class="btn btn-danger">Delete</button>
                                  </form>
