                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="admin/assets/images/R.png" alt="image" />
                              <span class="ps-2">{{$user->name}}</span>
                            </td>
                            <td> {{$user->pName}} </td>
                            <td> ${{$user->price}} </td>
                            <td> {{$user->quntity}} </td>
                            <td> ${{($user->price*$user->quntity)}} </td>
                            <td> {{$user->created_at}} </td>
                            <td>
                              <div class="badge badge-outline-danger">Approved</div>
                            </td>
                            <td>
                              <div class="">
                                <a href="{{url("/print_invoice/$user->user_id")}}" class="badge badge-outline-success" style="text-decoration: none">Confirmation</a>
                              </div>
                            </td>
                          </tr>
                          @endforeach
